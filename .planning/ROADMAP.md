...
**Plans**: 4 plans
- [ ] 05-01-PLAN.md — Foundation infra: ollama Docker service (mem_limit, internal-only, healthcheck) + ollama/tenacity deps + settings
- [ ] 05-02-PLAN.md — Provider seam: LLMProvider protocol + OllamaProvider (tenacity), /health Ollama probe, Wave 0 FakeLLMProvider test infra
